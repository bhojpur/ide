...
# This is the main entrypoint to application container in Bhojpur.NET Platform. It is called (and controlled) by
# the supervisor container root process.
...
# TODO ENVVAR CLEANUP: This stays here until we moved it to a central location, ideally platform-full
# (+ compatibility period)
# Also to mitigate compatibility issues let's try to source recently added configuration explicitly
[ -d "/home/bhojpur/.sdkman" ] && [ -z "$SDKMAN_DIR" ] && export SDKMAN_DIR="/home/bhojpur/.sdkman"
# shellcheck disable=SC1090,SC1091
[ -s /home/bhojpur/.sdkman/bin/sdkman-init.sh ] && [ -z "$SDKMAN_VERSION" ] && source "/home/bhojpur/.sdkman/bin/sdkman-init.sh"
# shellcheck disable=SC1090,SC1091
[ -s ~/.nvm/nvm-lazy.sh ] && source /home/bhojpur/.nvm/nvm-lazy.sh

cd /theia/platform-theia-app/app || exit
exec /theia/node/bin/bhojpur-node ./src-gen/backend/main.js --vscode-api-version=1.53.2 "$@"
